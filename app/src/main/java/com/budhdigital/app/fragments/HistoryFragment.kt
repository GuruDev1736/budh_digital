...
import com.budhdigital.app.adapters.HistoryAdapter
import com.budhdigital.app.databinding.FragmentHistoryBinding
import com.budhdigital.app.models.HistoryItem
import com.budhdigital.app.models.ServiceRequest
    ...
    private fun showRequestDetailsDialog(request: ServiceRequest) {
        context?.let { ctx ->
            ...
            dialog.getButton(AlertDialog.BUTTON_POSITIVE)?.setTextColor(
                ContextCompat.getColor(ctx, R.color.dark_green)
            )
        }
    }
